...
application {
    ...
    mainClass.set(requestedMain ?: "pathrag.ApplicationKt")
}
...
dependencies {
    ...
    // MongoDB
    implementation("org.mongodb:mongodb-driver-kotlin-coroutine:5.7.1")
    implementation("org.mongodb:bson-kotlinx:5.7.1")
